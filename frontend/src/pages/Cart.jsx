...
import { ShoppingCart, ShoppingCartIcon, Trash, Trash2 } from "lucide-react";
    ...
    <div className="pt-22 bg-gray-50 min-h-screen">
      {cart?.items?.length > 0 ? (
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w 7xl mx-auto flex gap-7 items-start justify-center">
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
          ...
          <div className="bg-pink-100 p-6 rounded-full">
            <ShoppingCart className="w-16 h-16 text-[#ff5252]" />
          </div>
          {/* title */}
          ...
          <Button
            ...
            className="mt-6 bg-[#ff5252] text-white hover:bg-[#ff5252]/80 cursor-pointer"
          >
            Start Shopping
          </Button>
        </div>
